...
class ListaChats : AppCompatActivity() {
    ...
    private fun initViews(){
        ...
        findViewById<androidx.recyclerview.widget.RecyclerView>(R.id.listChatsRecyclerView).layoutManager = LinearLayoutManager(this)
        findViewById<androidx.recyclerview.widget.RecyclerView>(R.id.listChatsRecyclerView).adapter =
            ChatAdapter { chat ->
                chatSelected(chat)
            }
        ...
        userRef.collection("chats")
            ...
            .addOnSuccessListener { chats ->
                ...
                (findViewById<androidx.recyclerview.widget.RecyclerView>(R.id.listChatsRecyclerView).adapter as ChatAdapter).setData(listChats)
            }
    ...
    private fun newChat(){
        ...
        val otherUser = findViewById<Button>(R.id.newChatButton).text.toString()
